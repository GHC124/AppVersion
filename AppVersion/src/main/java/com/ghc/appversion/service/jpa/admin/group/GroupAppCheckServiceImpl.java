...
import static com.ghc.appversion.service.jpa.admin.SQLConstants.GROUP_APP_CHECK_QUERY;
 ...
 * 
 */
@Service("GroupAppCheckService")
@Repository
@Transactional
public class GroupAppCheckServiceImpl implements GroupAppCheckService {
	...
	public Page<GroupAppCheck> findAllByPage(Pageable pageable,
			Long appId, long total) {
		// TODO use setParameter
		String sql = GROUP_APP_CHECK_QUERY;
		String orderBy = "";
		String sort = "";
		...
		List<GroupAppCheck> result = JpaUtil.getResultList(query,
				GroupAppCheck.class);
		Page<GroupAppCheck> page = new PageImpl<>(result, pageable, total);
